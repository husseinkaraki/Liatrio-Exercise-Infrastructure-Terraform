...
inputs = {
  ...
  private_subnet_ids  = tolist([dependency.vpc.outputs.private_subnet_1, dependency.vpc.outputs.private_subnet_2])
  ...
  # load_balancer_controller_iam_policy_name = "liatrio-lbc-iam-policy"

  # service_account_iam_role_enabled = true
  # service_account_iam_role_name = "liatrio-eks-service-acct-iam-role-prod"
